...
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("toggle-night-light"),                              { locked = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("toggle-night-light"),                              { locked = true })

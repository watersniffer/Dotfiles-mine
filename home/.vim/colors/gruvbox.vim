...
let s:gb.dark0       = ['#161616', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#1e1e1e', 236]     " 50-48-47
let s:gb.dark1       = ['#2a2a2a', 237]     " 60-56-54
let s:gb.dark2       = ['#484848', 239]     " 80-73-69
let s:gb.dark3       = ['#606060', 241]     " 102-92-84
let s:gb.dark4       = ['#707070', 243]     " 124-111-100
let s:gb.dark4_256   = ['#707070', 243]     " 124-111-100

let s:gb.gray_245    = ['#888888', 245]     " 146-131-116
let s:gb.gray_244    = ['#888888', 244]     " 146-131-116

let s:gb.light0_hard = ['#f3f3f3', 230]     " 249-245-215
let s:gb.light0      = ['#ffffff', 229]     " 253-244-193
let s:gb.light0_soft = ['#e4e4e4', 228]     " 242-229-188
let s:gb.light1      = ['#f0f0f0', 223]     " 235-219-178
let s:gb.light2      = ['#d8d8d8', 250]     " 213-196-161
let s:gb.light3      = ['#c0c0c0', 248]     " 189-174-147
let s:gb.light4      = ['#a0a0a0', 246]     " 168-153-132
let s:gb.light4_256  = ['#a0a0a0', 246]     " 168-153-132

let s:gb.bright_red     = ['#d0d0d0', 167]     " 251-73-52
let s:gb.bright_green   = ['#a9a9a9', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#e0e0e0', 214]     " 250-189-47
let s:gb.bright_blue    = ['#999999', 109]     " 131-165-152
let s:gb.bright_purple  = ['#9f9f9f', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#a9a9a9', 108]     " 142-192-124
let s:gb.bright_orange  = ['#ffffff', 208]     " 254-128-25

let s:gb.neutral_red    = ['#b0b0b0', 124]     " 204-36-29
let s:gb.neutral_green  = ['#989898', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#b8b8b8', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#707070', 66]      " 69-133-136
let s:gb.neutral_purple = ['#888888', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#888888', 72]      " 104-157-106
let s:gb.neutral_orange = ['#787878', 166]     " 214-93-14

let s:gb.faded_red      = ['#808080', 88]      " 157-0-6
let s:gb.faded_green    = ['#6a6a6a', 100]     " 121-116-14
let s:gb.faded_yellow   = ['#7e7e7e', 136]     " 181-118-20
let s:gb.faded_blue     = ['#4c4c4c', 24]      " 7-102-120
let s:gb.faded_purple   = ['#707070', 96]      " 143-63-113
let s:gb.faded_aqua     = ['#666666', 66]      " 66-123-88
let s:gb.faded_orange   = ['#575757', 130]     " 175-58-3
...
if !exists('g:rbpt_colorpairs')
  let g:rbpt_colorpairs =
    \ [
      \ ['blue', '#707070'], ['magenta', '#888888'],
      \ ['red',  '#b0b0b0'], ['166',     '#787878']
    \ ]
endif

let g:rainbow_guifgs = [ '#787878', '#b0b0b0', '#888888', '#707070' ]
